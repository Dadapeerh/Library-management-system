            ...
            <div className="form">
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className="shortDescriptiondescription">
                        <textarea value={shortDescription} onChange={ (e)=>setShortDescription(e.target.value)} name="" id="" cols="30" rows="10" required placeholder="shortDescription description of the book"></textarea>
                    </div>
                    <div className="longDescriptiondescription">
                        <textarea value={longDescription} onChange={ (e)=>setLongDescription(e.target.value)} name="" id="" cols="30" rows="10" required placeholder="longDescription description of the book"></textarea>
                    </div>
                    <div className="thumbnailthumbnailUrl">
                        <input value={thumbnailUrl} onChange={ (e)=>setthumbnailUrl(e.target.value)} type="text" required placeholder="thumbnail thumbnailUrl of the book" />
                    </div>
